...
const mockToken =
  'ey%419929aksjdmnxcvlaeoqwiehwqprqsdlasmdlqwskdfjsadklfnwnfawfn';
...
export const handlers = [
  ...
  rest.post('/api/posts', (__, res, ctx) =>
    res(ctx.status(200), ctx.json([mockFeedData, mockFeedData, mockFeedData]))
  ),
